        ...
        <div className="w-1/4 bg-white border-r border-gray-300">
          ...
          <header className="p-4 border-b border-gray-300 flex justify-between items-center bg-indigo-600 text-white">
            ...
            <div className="relative">
              <button id="menuButton" className="focus:outline-none" ref={menuButtonRef} onClick={handleMenuToggle}>
              ...
              <div id="menuDropdown"  ref={menuDropdownRef}  className={isMenuVisible ? 'absolute right-0 mt-2 w-48 bg-white border border-gray-300 rounded-md shadow-lg' : 'hidden'}  >
                <ul className="py-2 px-3">
                  <li><a href="#" className="block px-4 py-2 text-gray-800 hover:text-gray-400">Start conversation</a></li>
                  <li><a href="#" className="block px-4 py-2 text-gray-800 hover:text-gray-400">Log out</a></li>
