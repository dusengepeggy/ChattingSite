          ...
          <div className="w-full bg-gray-100 lg:w-1/2 flex items-center justify-center">
            <div className="max-w-md w-full p-6">
              ...
              <form  method="POST" className="space-y-4">
                ...
                <div>
                  <button type="submit" onClick={navigate("/chat")} className="w-full bg-black text-white p-2 rounded-md hover:bg-gray-800  focus:bg-black focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-900 transition-colors duration-300">Sign In</button>
                </div>
              </form>
              <div className="mt-4 text-sm text-gray-600 text-center">
                <p>Don't have an account? <Link to="/" className="text-black hover:underline">Sign up here</Link>
                </p>
              </div>
            </div>
          </div>
